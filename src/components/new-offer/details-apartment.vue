  ...
  <div :class="$style.apartment">
    <div :class="$style.apartment__row">
      ...
      <div :class="$style.row">
        ...
        <div :class="$style.row__33">
          <span :class="$style.validation" v-if="currentField === 'area_living'"></span>
        ...
        <div :class="$style.row__33">
          <span :class="$style.validation" v-if="currentField === 'area_kitchen'"></span>
          <default-number v-model="local.area_kitchen"
            :label="mdl.area_kitchen.title"
            :validate="validation.area_kitchen"
            msg="Обязательное поле"
          />
        </div>
      </div>
    ...
    computed: {
      validation: function () {
        return {
          ...
          area_kitchen: !!this.local.area_kitchen,
