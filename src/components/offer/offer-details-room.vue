  ...
  <div :class="$style.details">
    ...
    <div :class="$style.details__list">
      <ul :class="$style.list">
        ...
        <li :class="$style.list__item">
          <div :class="$style.item">
            <span :class="$style.item__title">{{ mdl.placement_type.title }}:</span>
            <span :class="$style.item__value">{{ humanize('placement_type', offer.placement_type) }}</span>
          </div>
        </li>
        <li :class="$style.list__item">
          <div :class="$style.item">
        ...
        <li :class="$style.list__item">
          <div :class="$style.item" v-if="!!offer.rooms">
        ...
        <li :class="$style.list__item">
          <div :class="$style.item" v-if="!!offer.condition_room">
            <span :class="$style.item__title">{{ mdl.condition_room.title }}:</span>
            <span :class="$style.item__value">{{ humanize('condition_room', offer.condition_room) }}</span>
          </div>
        </li>
        <li :class="$style.list__item">
          <div :class="$style.item" v-if="!!offer.condition_bath">
            <span :class="$style.item__title">{{ mdl.condition_bath.title }}:</span>
            <span :class="$style.item__value">{{ humanize('condition_bath', offer.condition_bath) }}</span>
          </div>
        </li>
        <li :class="$style.list__item">
