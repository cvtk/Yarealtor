      ...
      <ul :class="$style.list">
        <li :class="$style.list__item">
          <div :class="$style.item">
            ...
            <span :class="$style.item__value">Сдать комната</span>
          </div>
        </li>
        <li :class="$style.list__item">
          <div :class="$style.item">
        ...
        <li :class="$style.list__item" v-if="!!offer.accommodation">
          <div :class="$style.item">
            <span :class="$style.item__title">{{ mdl.accommodation.title }}:</span>
            <span :class="$style.item__value">{{ humanize('accommodation', offer.accommodation) }}</span>
          </div>
        </li>
