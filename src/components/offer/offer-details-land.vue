      ...
      <ul :class="$style.list">
        ...
        <li :class="$style.list__item">
          <div :class="$style.item">
            ...
            <span :class="$style.item__value">{{ offer.localityType }}. {{ offer.locality }}</span>
          </div>
        </li>
        <li :class="$style.list__item">
          <div :class="$style.item"  v-if="!!offer.district">
            <span :class="$style.item__title">{{ mdl.district.title }}:</span>
        ...
        <li :class="$style.list__item">
          <div :class="$style.item">
            <span :class="$style.item__title">{{ mdl.land_type.title }}:</span>
            <span :class="$style.item__value">{{ humanize('land_type', offer.land_type) }}</span>
          </div>
        </li>
        <li :class="$style.list__item">
          <div :class="$style.item">
        ...
        <li :class="$style.list__item">
          <div :class="$style.item" v-if="!!landInfrastrucure">
            <span :class="$style.item__title">Инфраструктура:</span>
            <span :class="$style.item__value">{{ landInfrastrucure }}</span>
          </div>
        </li>
      </ul>
    </div>
